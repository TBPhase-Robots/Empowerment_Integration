...
def saveConfig(fname = 'cfg.npy'):
    ...
    cfg = {"world" : {
        ...
        "sheep" : {
            ...
            "initial_positions" : [(20, 20), (22, 19), (19, 22)], #(24, 21), (35, 49), (50, 21), (15, 47), (16, 27), (17, 27), (37, 21), (36, 31), (11, 32), (27, 45), (50, 34), (44, 45)],
        ...
        "dog" : {
            ...
            "initial_positions" : [(10, 10), (12, 10), (10, 12), (14, 8), (8, 14), (17, 8), (8, 17)],
            ...
            #set True to calculate empowerment based only on states which move the sheep towards the goal
            "use_taskweighted_empowerment_b" : False,
            #set True to change the dog's colour in response to its empowerment value
            "show_empowerment_b": False,
            #set True to show numberical empowerment values
            "show_empowerment_values_b": False,
        ...
        "sim" : {
            ...
            "tick_rate" : 15,
            #the length of time the simulation continues to run after the dogs have completed the task (currently in simulation ticks)
            "post_task_run_time" : 30
        }
    }
    np.save(fname, cfg)
